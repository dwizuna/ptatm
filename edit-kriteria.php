        ...
        <!-- form start -->
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="proses-edit-kriteria.php?id=<?php echo $_GET['id'];?>">
			  ...
			  <div class="box-body">
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
					<input type="number" step="0.01" class="form-control" name="bobot" id="bobot" value="<?php echo $row["bobot"];?>" placeholder="Bobot Kriteria" required >
                  </div>
                </div>
				<div class="form-group">
              ...
              <div class="box-footer">
				<a type="button" class="btn btn-danger" href="kriteria.php">Cancel</a>
