  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Penilian</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title text-success"><i class="fa fa-list"> </i> Edit Penilaian</h3>
            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="proses-edit-penilaian.php?id=<?php echo $_GET['id'];?>">
			  ...
			  <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $row['nama'];?>" placeholder="Nama" required readonly="" />
                  </div>
                </div>
				 <div class="form-group">
                  <label for="k1" class="col-sm-4 control-label"><?php echo $k[0];?></label>

                  <div class="col-sm-8">
					<input type="number" min="1" max="100" step="1" class="form-control" name="k1" id="k1" value="<?php echo $row["k1"];?>" placeholder="Bobot <?php echo $k[0];?>" required >
                  </div>
                </div>
				<div class="form-group">
                  <label for="k2" class="col-sm-4 control-label"><?php echo $k[1];?></label>

                  <div class="col-sm-8">
					<input type="number" min="1" max="100" step="1" class="form-control" name="k2" id="k2" value="<?php echo $row["k2"];?>" placeholder="Bobot <?php echo $k[1];?>" required >
                  </div>
                </div>
				<div class="form-group">
                  <label for="k3" class="col-sm-4 control-label"><?php echo $k[2];?></label>

                  <div class="col-sm-8">
					<input type="number" min="1" max="100" step="1" class="form-control" name="k3" id="k3" value="<?php echo $row["k3"];?>" placeholder="Bobot <?php echo $k[2];?>" required >
                  </div>
                </div>
				<div class="form-group">
                  <label for="k4" class="col-sm-4 control-label"><?php echo $k[3];?></label>

                  <div class="col-sm-8">
					<input type="number" min="1" max="100" step="1" class="form-control" name="k4" id="k4" value="<?php echo $row["k4"];?>" placeholder="Bobot <?php echo $k[3];?>" required >
                  </div>
                </div>
				<div class="form-group">
                  <label for="k5" class="col-sm-4 control-label"><?php echo $k[4];?></label>

                  <div class="col-sm-8">
					<input type="number" min="1" max="100" step="1" class="form-control" name="k5" id="k5" value="<?php echo $row["k5"];?>" placeholder="Bobot <?php echo $k[4];?>" required >
                  </div>
                </div>
				<div class="form-group">
                  <label for="k6" class="col-sm-4 control-label"><?php echo $k[5];?></label>

                  <div class="col-sm-8">
					<input type="number" min="1" max="100" step="1" class="form-control" name="k6" id="k6" value="<?php echo $row["k6"];?>" placeholder="Bobot <?php echo $k[5];?>" required >
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
