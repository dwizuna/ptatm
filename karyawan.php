						...
						$i = 1;
							if($result->num_rows != 0){
								while ($row = $result->fetch_assoc()) {
									...
									echo "<td>".ucwords($row['jenis_kelamin'])."</td>";
									...
									<a href="delete-karyawan.php?id=<?php echo $row['id_karyawan'];?>" onClick="return confirm('Hapus Data Karyawan <?php echo $row['nama'];?>  ?');" class="fa fa-close btn btn-danger btn-sm"></a>
